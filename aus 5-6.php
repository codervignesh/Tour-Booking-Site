...
<body>
    <script>
        ...
        function validation() {
            ...
            if (adult == "" || isNaN(adult) || isNaN(child)){
                alert("enter valid no of travellers");
                return false;
            }
            ...
            if (name != '' && mail != '' && contact != "" && name.length > 3 && name.length < 30 && contact.length == 10 && adult !='' && !isNaN(adult) && !isNaN(child)) {
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <center><b><font size = "3px">AUSTRALIA 5 DAYS / 6 NIGHTS</font></b></center>
            <center><p>** LEAVE THE DATE FIELD EMPTY IF YOU WANT TO TALK ABOUT TRAVEL DATE TO CUSTOMER CARE EXECUTIVE **</p></center>
            <div class="divi">
                <form action="aus1.php" method="post" name="booking" onsubmit="validation()">
