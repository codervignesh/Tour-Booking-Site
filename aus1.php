<?php
    ...
    $price = $adult * 120500 + $child * 75000 ;
    ...
    else
    {
        ...
        $stmt = $con->prepare("INSERT into `aus-5/6`(`name`,`email`, `contact`, `date`,`adult`,`child`, `price`, `state`) VALUES('$name', '$mail', '$no', '$from','$adult', '$child', '$price', '$state')");
        $stmt->execute();
