...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <center><b><font size = "3px">BRAZIL 7 DAYS / 8 NIGHTS</font></b></center>
            <center><p>** LEAVE THE DATE FIELD EMPTY IF YOU WANT TO TALK ABOUT TRAVEL DATE TO CUSTOMER CARE EXECUTIVE **</p></center>
            <div class="divi">
                <form action="brazil2.php" method="post" name="booking" onsubmit="validation()">
                    ...
                    <table id="tab">
                        <tr>
                            <td>
                                <div class="no">
                                    <label for="nu">Number of Adult</label>
