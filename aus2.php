<?php
    ...
    $price = $adult * 180500 + $child * 120000;;
    ...
    else
    {
        ...
        $stmt = $con->prepare("INSERT into `aus-7/8`(`name`,`email`, `contact`, `date`,`adult`,`child`, `price`, `state`) VALUES('$name', '$mail', '$no', '$from','$adult', '$child', '$price', '$state')");
        $stmt->execute();
